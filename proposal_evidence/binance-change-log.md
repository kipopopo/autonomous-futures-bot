...
Welcome to the new Binance API documentation.Looking for the previous version?Switch to the legacy docs

[![Image 1: Binance Developer Docs](https://developers.binance.com/en/docs/binance-logo.svg)![Image 2: Binance Developer Docs](https://developers.binance.com/en/docs/binance-logo.svg)](https://developers.binance.com/en/docs)

Search

Ask AI

[Legacy Docs](https://developers.binance.com/legacy-docs)

Language

*   [Documentation](https://developers.binance.com/en/docs/introduction)
*   [API Reference](https://developers.binance.com/en/docs/catalog)
*   [SDKs & Tools](https://developers.binance.com/en/docs/sdks-tools/overview)
*   [Agent Native](https://developers.binance.com/en/docs/agent-native/overview)

[Dev Forum](https://dev.binance.vision/)[Binance.com](https://www.binance.com/en)
...
*   [Product Feedback](https://www.binance.com/en/my/user-support/feedback/entry)
*   [Fees](https://www.binance.com/en/fee/trading)

Agent Native
*   [llms.txt](https://developers.binance.com/en/docs/llms.txt)
*   [llms-full.txt](https://developers.binance.com/en/docs/llms-full.txt)
*   [Agent Native](https://developers.binance.com/en/docs/agent-native/overview)

![Image 3: Binance Developer Docs](https://developers.binance.com/en/docs/binance-logo.svg)![Image 4: Binance Developer Docs](https://developers.binance.com/en/docs/binance-logo.svg)
© 2026 Binance.com. All rights reserved.

[![Image 5: github](https://cdn.simpleicons.org/github/000000/ffffff)](https://github.com/binance)[![Image 6: x](https://cdn.simpleicons.org/x/000000/ffffff)](https://x.com/binance)[![Image 7: telegram](https://cdn.simpleicons.org/telegram/000000/ffffff)](https://t.me/binance_api_english)

GET STARTED

[Introduction](https://developers.binance.com/en/docs/introduction)
...
[Introduction](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/Introduction)[Quick Start](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/quick-start)[Change Log](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log)[General Info](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/general-info)[WebSocket API General Info](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/websocket-api-general-info)[User Data Streams](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/user-data-streams)[Public Endpoints Info](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/common-definition)[Error Codes](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/error-code)

Websocket Market Streams

Faq

[REST API](https://developers.binance.com/en/docs/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/rest-api)[WebSocket API](https://developers.binance.com/en/docs/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/ws-api)[WebSocket Streams](https://developers.binance.com/en/docs/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/ws-streams)
...
Task Verification API Endpoint
...
# Change Log[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#change-log)

## 2026-07-29[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2026-07-29)
...
## 2026-07-23[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2026-07-23)
...
## 2026-07-21[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2026-07-21)

**Effective Date: 2026-07-30**

USDⓈ-M Futures

*   `PUT /fapi/v1/order` (Modify Order), `PUT /fapi/v1/batchOrders` (Modify Multiple Orders), and the WebSocket API `order.modify`
    *   New optional request parameter `modifyId` (INT): a user-defined modification identifier that the server passes through as-is; not validated for uniqueness. If omitted, it is not returned.
...
*   User Data Stream `ORDER_TRADE_UPDATE` event (`"x": "AMENDMENT"`)
    *   New field `M` (STRING): the `modifyId` from the corresponding modify request; only pushed when a `modifyId` was provided.

COIN-M Futures

*   `PUT /dapi/v1/order` (Modify Order), `PUT /dapi/v1/batchOrders` (Modify Multiple Orders), and the WebSocket API `order.modify`
    *   New optional request parameter `modifyId` (INT): a user-defined modification identifier that the server passes through as-is; not validated for uniqueness. If omitted, it is not returned.
    *   The response now returns `modifyId` when it was provided in the request.
...
## 2026-07-16[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2026-07-16)
...
*   `GET /fapi/v1/tradingSchedule` (Trading Schedule)
    *   Now covers the Hong Kong equity market (`HK_EQUITY`), with session types `REGULAR` and `NO_TRADING`.

*   WebSocket Trading Session Stream (`tradingSession`)
    *   New event type `HK_EquityUpdate` for the Hong Kong equity market, with session types `REGULAR` and `NO_TRADING`.

* * *

## 2026-07-13[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2026-07-13)

**Effective Date: 2026-07-14**

Portfolio Margin

*   The `cumBase`, `cumQuote` and `avgPrice` fields will be removed from the responses of the following endpoints:
...
## 2026-07-09[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2026-07-09)
...
*   `GET /eapi/v1/exchangeInfo` (Exchange Information)
    *   Response `optionSymbols` now includes `contractType` and `underlyingType` fields for each option symbol, indicating the contract type and underlying type.

* * *

## 2026-06-30[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2026-06-30)
...
## 2026-06-29[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2026-06-29)
...
## 2026-06-20[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2026-06-20)
...
## 2026-06-16[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2026-06-16)

**Time-sensitive Notice**

*   Please note the Futures COIN-M demo trading will be unavailable from 2026-06-16 02:00 till 10:00 UTC.
*   **Update:** The Futures COIN-M demo trading maintenance window is extended. The new window is from 2026-06-16 02:00:00 till 2026-06-23 10:00:00 (UTC). We appreciate your patience and understanding.

* * *

## 2026-06-10[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2026-06-10)

**Effective Date: 2026-06-30**

COIN-M Futures architecture integration with USDⓈ-M Futures — REST endpoints, WebSocket streams, and account-level behavior changes. See [Important CM-UM Integration Notice](https://developers.binance.com/en/docs/products/derivatives-trading-coin-futures/Important-CM-UM-Integration-Notice) for the full list of affected endpoints and the action items. For the detailed timeline, please refer to the [announcement](https://www.binance.com/en/support/announcement/detail/2a84dfd7643f4dc18084e45e8691b69e).

* * *

## 2026-06-02[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2026-06-02)
...
## 2026-05-11[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2026-05-11)
...
## 2026-04-17[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2026-04-17)
...
## 2026-04-15[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2026-04-15)
...
## 2026-04-14[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2026-04-14)
...
## 2026-04-13[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2026-04-13)
...
## 2026-04-10[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2026-04-10)
...
## 2026-04-09[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2026-04-09)

Portfolio Margin

*   User Data Stream
    *   [Event: Margin Order Update](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/pm/user-data-streams/Event-Margin-Order-Update) - Added new fields to the `executionReport` event payload: `Cs`, `pl`, `pL`, `pY`, `eR`.

* * *

## 2026-04-08[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2026-04-08)
...
## 2026-04-06[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2026-04-06)
...
## 2026-04-02[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2026-04-02)

USDⓈ-M Futures

*   WebSocket
    *   Updated [important websocket change notice](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/websocket-market-streams/Important-WebSocket-Change-Notice) with legacy URL decommissioning date: **2026-04-23**.

* * *

## 2026-03-19[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2026-03-19)
...
## 2026-03-16[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2026-03-16)
...
## 2026-03-11[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2026-03-11)
...
## 2026-03-05[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2026-03-05)

USDⓈ-M Futures

*   WebSocket
    *   Add [important websocket change notice](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/usds-margined-futures/websocket-market-streams/Important-WebSocket-Change-Notice).
...
## 2026-01-09[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2026-01-09)
...
## 2026-01-07[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2026-01-07)
...
## 2025-12-29[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2025-12-29)
...
## 2025-12-11[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2025-12-11)
...
## 2025-12-10[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2025-12-10)
...
## 2025-12-09[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2025-12-09)

COIN-M Futures

*   Effective on 2025-12-10, Order expire reason field `er` will be available in `ORDER_TRADE_UPDATE` stream.

## 2025-11-25[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log#2025