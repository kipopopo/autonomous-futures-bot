...
# General Info[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/general-info#general-info)

## General API Information[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/general-info#general-api-information)
...
### Testnet API Information[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/general-info#testnet-api-information)
...
## General Information on Endpoints[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/general-info#general-information-on-endpoints)
...
### HTTP Return Codes[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/general-info#http-return-codes)
...
### HTTP 503 Status: Message Variants & Handling[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/general-info#http-503-status-message-variants--handling)

#### A. “Unknown error, please check your request or try again later.” (Execution status **unknown**)[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/general-info#a-unknown-error-please-check-your-request-or-try-again-later-execution-status-unknown)
...
#### B. “Service Unavailable.” (Failure)[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/general-info#b-service-unavailable-failure)
...
#### C. “Request throttled by system-level protection. Reduce-only/close-position orders are exempt. Please try again.” (**-1008**, Failure)[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/general-info#c-request-throttled-by-system-level-protection-reduce-onlyclose-position-orders-are-exempt-please-try-again--1008-failure)
...
### Error Codes and Messages[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/general-info#error-codes-and-messages)
...
## SDK and Code Demonstration[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/general-info#sdk-and-code-demonstration)
...
### Python3[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/general-info#python3)
...
### Java[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/general-info#java)
...
## LIMITS[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/general-info#limits)
...
### IP Limits[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/general-info#ip-limits)
...
### Order Rate Limits[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/general-info#order-rate-limits)
...
## Endpoint Security Type[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/general-info#endpoint-security-type)
...
### SIGNED (TRADE and USER_DATA) Endpoint Security[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/general-info#signed-trade-and-user_data-endpoint-security)
...
### Timing Security[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/general-info#timing-security)
...
### SIGNED Endpoint Examples for POST /fapi/v1/order - HMAC Keys[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/general-info#signed-endpoint-examples-for-post-fapiv1order---hmac-keys)
...
#### Example 1: As a query string[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/general-info#example-1-as-a-query-string)
...
#### Example 2: As a request body[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/general-info#example-2-as-a-request-body)
...
#### Example 3: Mixed query string and request body[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/general-info#example-3-mixed-query-string-and-request-body)
...
### SIGNED Endpoint Examples for POST /fapi/v1/order - RSA Keys[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/general-info#signed-endpoint-examples-for-post-fapiv1order---rsa-keys)
...
apiKey="[REDACTED]"   ### REPLACE THIS WITH YOUR API KEY
...
## Postman Collections[](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/general-info#postman-collections)
...
[Change Log](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/change-log)[WebSocket API General Info](https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/websocket-api-general-info)
