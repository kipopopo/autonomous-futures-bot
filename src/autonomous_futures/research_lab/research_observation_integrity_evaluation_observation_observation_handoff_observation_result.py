...
class ResearchObservationIntegrityEvaluationObservationObservationHandoffObservationReview(
    DomainModel
):
...
def research_observation_integrity_evaluation_observation_observation_handoff_observation_review_content_hash(
...
def build_research_observation_integrity_evaluation_observation_observation_handoff_observation_review(
    observation: ResearchObservationIntegrityEvaluationObservationObservationHandoffObservationInput,
    *,
    reviewed_at: datetime | None = None,
) -> ResearchObservationIntegrityEvaluationObservationObservationHandoffObservationReview:
    try:
        ResearchObservationIntegrityEvaluationObservationObservationHandoffObservationInput.model_validate(
