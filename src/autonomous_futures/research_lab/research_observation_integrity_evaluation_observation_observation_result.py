...
class ResearchObservationIntegrityEvaluationObservationObservationReview(DomainModel):
    ...
    def valid_hash(self) -> ResearchObservationIntegrityEvaluationObservationObservationReview:
        if (
...
def research_observation_integrity_evaluation_observation_observation_review_content_hash(
    r: ResearchObservationIntegrityEvaluationObservationObservationReview,
) -> str:
    return sha256(
        json.dumps(
...
def build_research_observation_integrity_evaluation_observation_observation_review(
    ...
    *,
    ...
    try:
        ResearchObservationIntegrityEvaluationObservationObservationInput.model_validate(
