# Phase 182 Verification — complete-lineage Critic-guided proposal
...
Use `critic-evidence-024` with the union of verified persisted registry/artifact IDs and historical proposal IDs:
...
proposal:                proposal-doge-regime-breakout-010
