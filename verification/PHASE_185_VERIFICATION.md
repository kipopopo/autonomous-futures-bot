# Phase 185 Verification — complete-lineage Critic-guided proposal
...
Use `critic-evidence-025` with the union of verified persisted registry/artifact IDs and historical proposal IDs:
...
proposal:                proposal-doge-regime-breakout-011
