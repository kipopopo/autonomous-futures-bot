# Phase 186 Verification — current full Critic-guided chain
...
Run the full chain from `critic-evidence-025` using the complete persisted+historical lineage guard:
...
```text
source candidate:       cand-doge-regime-breakout-010
critic evidence:        critic-evidence-025
forbidden prior IDs:    28
provider requests:      1
candidate:              cand-doge-regime-breakout-011
trial:                  accepted_for_testing
candidate state:        testing
OOS windows:            4
trades:                 699
pooled net P&L:         -7.0396458735139669894125653 USDT
pooled profit factor:   0.9743662456128034802007724563
...
```text
/var/lib/autonomous-futures/research/dogeusdt-365d/creator-batch-20260822-028
```
...
4d79617c3eb8c531a94af1240ae8408f72c5fee9a1080421ca19e7efd3f3f497

qualification hash:
d3f3d09b240a9b73fb5a681ebaa38a683f43472564c53e7a86c5eefca89a8e76
```
