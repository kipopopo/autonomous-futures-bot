# Phase 188 Verification — complete-lineage Critic-guided proposal
...
Use `critic-evidence-026` with the union of verified persisted registry/artifact IDs and historical proposal IDs:
...
proposal:                proposal-doge-regime-breakout-012
